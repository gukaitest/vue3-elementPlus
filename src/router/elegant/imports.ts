...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "personal-content_canvas-optimization": () => import("@/views/personal-content/canvas-optimization/index.vue"),
  "personal-content_difficulties-presentation": () => import("@/views/personal-content/difficulties-presentation/index.vue"),
  "personal-content_echarts-optimization": () => import("@/views/personal-content/echarts-optimization/index.vue"),
  "personal-content_el-select-tree-optimization": () => import("@/views/personal-content/el-select-tree-optimization/index.vue"),
